...
namespace StarPizzaShop.Controllers
{
    public class CustomerController : Controller
    {
        ...
        //public async Task<IActionResult> Create([Bind("Id,FullName,Telephone")] Customer customer)
        //{
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Telephone")] Customer customer)
        //{
        //    if (id != customer.Id)
        //    {
        //        return NotFound();
